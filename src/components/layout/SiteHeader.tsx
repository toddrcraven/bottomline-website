...
export function SiteHeader() {
  ...
  return (
    <header className="site-header sticky top-0 z-50 border-b border-borderSoft/80 bg-[color:var(--slate-600)]/90 backdrop-blur">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={[
                  "group relative z-10 inline-flex items-center rounded-full px-3 py-1.5 text-sm font-medium transition",
                  "bg-white/5 hover:bg-white/10",
                  "text-[color:var(--text-muted,#cbd5e1)] hover:text-white",
                  ...
                  active
                    ? [
                        ...
                        "after:bg-brandGreen/60 after:blur-md after:opacity-100",
                        "shadow-[0_8px_24px_-12px_rgba(34,197,94,0.50)]",
                      ].join(" ")
      ...
      <div className="border-t border-borderSoft/80 bg-[color:var(--slate-600)]/95 px-4 py-3 md:hidden">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                aria-current={active ? "page" : undefined}
                className={[
                  "group relative z-10 inline-flex items-center rounded-full px-3 py-1.5 text-sm font-medium transition whitespace-nowrap",
                  "bg-white/5 hover:bg-white/10",
                  "text-[color:var(--text-muted,#cbd5e1)] hover:text-white",
                  "outline-none focus-visible:ring-2 focus-visible:ring-brandGreen/50 focus-visible:ring-offset-0",
                  active
